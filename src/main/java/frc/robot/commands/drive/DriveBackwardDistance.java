 ...
 * Add your docs here.
 */
public class DriveBackwardDistance extends DriveCommandBase {

    /** Our classes' logger **/
    private static final PKLogger logger = RioLogger.getLogger(DriveBackwardDistance.class.getName());

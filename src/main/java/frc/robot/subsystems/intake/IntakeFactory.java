...
public class IntakeFactory {
    ...
    /** Our classes' logger **/
    private static final PKLogger logger = RioLogger.getLogger(IntakeFactory.class.getName());
    ...
    private static void loadImplementationClass(String myClassName) {
        ...
        try {
            ...
            ourInstance.setDefaultCommand(new IntakeDoNothing());
            SmartDashboard.putNumber(TelemetryNames.Intake.status, PKStatus.degraded.tlmValue);
        }
        SmartDashboard.putString(TelemetryNames.Intake.implClass, ourInstance.getClass().getSimpleName());
    }

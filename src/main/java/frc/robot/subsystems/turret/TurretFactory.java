...
public class TurretFactory {
    ...
    /** Our classes' logger **/
    private static final PKLogger logger = RioLogger.getLogger(TurretFactory.class.getName());

    /** Singleton instance of class for all to use **/
    private static ITurretSubsystem ourInstance;
    /** Name of our subsystem **/
    private static final String myName = SubsystemNames.turretName;
    ...
    public static synchronized void constructInstance() {
        SmartDashboard.putNumber(TelemetryNames.Turret.status, PKStatus.inProgress.tlmValue);
    ...
    private static void loadImplementationClass(String myClassName) {
        String myPkgName = TurretFactory.class.getPackage().getName();
        ...
        try {
            ...
            ourInstance = (ITurretSubsystem) myObject;
            SmartDashboard.putNumber(TelemetryNames.Turret.status, PKStatus.success.tlmValue);
        } catch (ClassNotFoundException | InstantiationException | IllegalAccessException ex) {
            logger.error("failed to load class; instantiating default stub for: {}", myName);
            ourInstance = new StubTurretSubsystem();
            ourInstance.setDefaultCommand(new TurretDoNothing());
            SmartDashboard.putNumber(TelemetryNames.Turret.status, PKStatus.degraded.tlmValue);
        }
        SmartDashboard.putString(TelemetryNames.Turret.implClass, ourInstance.getClass().getSimpleName());
    }
     ...
     **/
    public static ITurretSubsystem getInstance() {
        if (ourInstance == null) {

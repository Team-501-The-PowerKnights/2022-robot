...
public class ElevatorFactory {
    ...
    /** Our classes' logger **/
    private static final PKLogger logger = RioLogger.getLogger(ElevatorFactory.class.getName());

    /** Singleton instance of class for all to use **/
    private static IElevatorSubsystem ourInstance;
    /** Name of our subsystem **/
    private static final String myName = SubsystemNames.elevatorName;
    ...
    private static void loadImplementationClass(String myClassName) {
        String myPkgName = ElevatorFactory.class.getPackage().getName();
        ...
        try {
            ...
            ourInstance = (IElevatorSubsystem) myObject;
            SmartDashboard.putNumber(TelemetryNames.Elevator.status, PKStatus.success.tlmValue);
        } catch (ClassNotFoundException | InstantiationException | IllegalAccessException ex) {
            logger.error("failed to load class; instantiating default stub for: {}", myName);
            ourInstance = new StubElevatorSubsystem();
            ourInstance.setDefaultCommand(new ElevatorDoNothing());
     ...
     **/
    public static IElevatorSubsystem getInstance() {
        if (ourInstance == null) {

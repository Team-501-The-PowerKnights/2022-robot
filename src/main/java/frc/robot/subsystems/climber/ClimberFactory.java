...
public class ClimberFactory {
    ...
    /** Our classes' logger **/
    private static final PKLogger logger = RioLogger.getLogger(ClimberFactory.class.getName());
    ...
    private static void loadImplementationClass(String myClassName) {
        ...
        SmartDashboard.putString(TelemetryNames.Climber.implClass, ourInstance.getClass().getSimpleName());
    }
